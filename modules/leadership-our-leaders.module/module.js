(function () {
  var SECTION_SELECTOR = "[data-leadership-our-leaders]";
  ...
  function initCarousel(section) {
    var slides = section.querySelectorAll("[data-leadership-slide]");
    if (!slides.length) return;

    var active = 0;
    var curEl = section.querySelector("[data-leadership-cur]");
    var btnPrev = section.querySelector("[data-leadership-prev]");
    var btnNext = section.querySelector("[data-leadership-next]");
  ...
  document.querySelectorAll(SECTION_SELECTOR).forEach(function (section) {
    if (section.getAttribute("data-leadership-inited") === "true") return;
    section.setAttribute("data-leadership-inited", "true");
